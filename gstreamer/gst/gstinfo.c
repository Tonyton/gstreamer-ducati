...
#else
    __android_log_print (ANDROID_LOG_INFO, "GST-dbg",
        "%" GST_TIME_FORMAT " "PID_FMT" "PTR_FMT" %s "CAT_FMT" %s\n",
        GST_TIME_ARGS (elapsed), pid, g_thread_self (), gst_debug_level_get_name (level),
        gst_debug_category_get_name (category), file, line, function, obj,
        gst_debug_message_get (message));
#endif
