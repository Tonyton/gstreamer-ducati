...
#include <utils/Log.h>
#undef LOG_TAG
#define LOG_TAG "gst_audio_finger_sink"
...
static gboolean gst_audioflinger_sink_prepare (GstAudioSink * asink, GstRingBufferSpec * spec)
{
...
static guint gst_audioflinger_sink_write (GstAudioSink * asink, gpointer data, guint length)
{
	GstAudioFlingerSink *audioflinger;
	guint ret = 0;
...
static void gst_audioflinger_sink_set_mute (GstAudioFlingerSink * audioflinger_sink,
    gboolean mute)
{
...
static void gst_audioflinger_sink_set_volume (GstAudioFlingerSink * audioflinger_sink,
    float volume)
{
...
static GstStateChangeReturn gst_audioflinger_sink_change_state (GstElement * element,
