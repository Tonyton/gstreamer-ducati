...
LIBAV_CONFIG_MAK=1
LIBAV_CONFIGURATION=--target-os=linux --arch=arm --cpu=cortex-a8 --enable-gpl --enable-nonfree --disable-shared --disable-decoder=cavs --enable-static --disable-ffplay --enable-avfilter --disable-network --enable-cross-compile --cc=arm-eabi-gcc --cross-prefix=arm-eabi- --nm=arm-eabi-nm --extra-cflags='-fPIC -DANDROID -mno-thumb-interwork -mno-thumb -marm -mfpu=neon -mfloat-abi=softfp -fPIC -DANDROID ' --disable-asm --extra-ldflags='-Wl,-T,$ANDROID_ROOT/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=$ANDROID_ROOT/prebuilt/ndk/android-ndk-r4/platforms/android-8/arch-arm/usr/lib/ -L$ANDROID_ROOT/prebuilt/ndk/android-ndk-r4/platforms/android-8/arch-arm/usr/lib/ -nostdlib $ANDROID_ROOT/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/lib/gcc/arm-eabi/4.4.3/crtbegin.o $ANDROID_ROOT/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/lib/gcc/arm-eabi/4.4.3/crtend.o -lc -lm -ldl -mfpu=neon -mfloat-abi=softfp '
prefix=/usr/local
...
SRC_PATH="/home/tj/workspace/gstreamer/freedesktop/gstreamer/gst-ffmpeg/gst-libs/ext/libav"
SRC_PATH_BARE=/home/tj/workspace/gstreamer/freedesktop/gstreamer/gst-ffmpeg/gst-libs/ext/libav
...
CFLAGS= -fPIC -DANDROID -mno-thumb-interwork -mno-thumb -marm -mfpu=neon -mfloat-abi=softfp -fPIC -DANDROID -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -fPIC -DANDROID -mno-thumb-interwork -mno-thumb -marm -mfpu=neon -mfloat-abi=softfp -fPIC -DANDROID -mcpu=cortex-a8 -g
CC_O=-o $@
DLLTOOL=
LDFLAGS= -Wl,-T,/data/android/sideswipe_panda/android-panda/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/data/android/sideswipe_panda/android-panda/prebuilt/ndk/android-ndk-r4/platforms/android-8/arch-arm/usr/lib/ -L/data/android/sideswipe_panda/android-panda/prebuilt/ndk/android-ndk-r4/platforms/android-8/arch-arm/usr/lib/ -nostdlib /data/android/sideswipe_panda/android-panda/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/lib/gcc/arm-eabi/4.4.3/crtbegin.o /data/android/sideswipe_panda/android-panda/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/lib/gcc/arm-eabi/4.4.3/crtend.o -lc -lm -ldl -mfpu=neon -mfloat-abi=softfp -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,libpostproc -Wl,-rpath-link,libswscale -Wl,-rpath-link,libavfilter -Wl,-rpath-link,libavdevice -Wl,-rpath-link,libavformat -Wl,-rpath-link,libavcodec -Wl,-rpath-link,libavutil
...
libavformat_VERSION=53.2.0
libavformat_VERSION_MAJOR=53
libavutil_VERSION=51.7.0
libavutil_VERSION_MAJOR=51
libavfilter_VERSION=2.4.0
...
VCODEC_TESTS=asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_rd dv dv50 error ffv1 flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2thread mpeg4 mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 qtrle rc rgb roq rv10 rv20 snow snowll svq1 vref wmv1 wmv2 yuv 
