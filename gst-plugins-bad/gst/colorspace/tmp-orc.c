...
#ifdef DISABLE_ORC
void
cogorc_memcpy_2d (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
...
#ifdef DISABLE_ORC
void
cogorc_downsample_horiz_cosite_3tap (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_downsample_420_jpeg (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_union16 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_downsample_vert_halfsite_2tap (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_downsample_vert_cosite_3tap (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_downsample_vert_halfsite_4tap (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_upsample_horiz_cosite (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_upsample_vert_avgub (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_pack_yuyv (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
...
#ifdef DISABLE_ORC
void
orc_pack_uyvy (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix2_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, int p1, int p2, int p3, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix2_11_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix2_12_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix3_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int p2, int p3, int p4, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix3_100_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int p2, int p3, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix3_100_offset_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int p2, int p3, int p4, int p5, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_matrix3_000_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int p2, int p3, int p4, int p5, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
orc_pack_123x (guint32 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergewl */
    var38.i = ((orc_uint16)var39.i & 0x0000ffff) | ((orc_uint16)var40.i << 16);
    /* 7: storel */
    ptr0[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
orc_pack_x123 (guint32 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int p1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_combine2_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_convert_I420_UYVY (guint8 * d1, guint8 * d2, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  ...
  for (i = 0; i < n; i++) {
    ...
    var35 = ptr4[i];
    /* 4: mergebw */
    var36.x2[0] = ((orc_uint8)var39.x2[0] & 0x00ff) | ((orc_uint8)var35.x2[0] << 8);
    var36.x2[1] = ((orc_uint8)var39.x2[1] & 0x00ff) | ((orc_uint8)var35.x2[1] << 8);
    /* 5: storel */
    ptr0[i] = var36;
    /* 6: loadw */
    var37 = ptr5[i];
    /* 7: mergebw */
    var38.x2[0] = ((orc_uint8)var39.x2[0] & 0x00ff) | ((orc_uint8)var37.x2[0] << 8);
    var38.x2[1] = ((orc_uint8)var39.x2[1] & 0x00ff) | ((orc_uint8)var37.x2[1] << 8);
    /* 8: storel */
    ptr1[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_I420_YUY2 (guint8 * d1, guint8 * d2, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  orc_union32 * ORC_RESTRICT ptr1;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (i = 0; i < n; i++) {
    ...
    var35 = ptr4[i];
    /* 4: mergebw */
    var36.x2[0] = ((orc_uint8)var35.x2[0] & 0x00ff) | ((orc_uint8)var39.x2[0] << 8);
    var36.x2[1] = ((orc_uint8)var35.x2[1] & 0x00ff) | ((orc_uint8)var39.x2[1] << 8);
    /* 5: storel */
    ptr0[i] = var36;
    /* 6: loadw */
    var37 = ptr5[i];
    /* 7: mergebw */
    var38.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var39.x2[0] << 8);
    var38.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var39.x2[1] << 8);
    /* 8: storel */
    ptr1[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_I420_AYUV (guint8 * d1, guint8 * d2, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  orc_union32 * ORC_RESTRICT ptr1;
  const orc_int8 * ORC_RESTRICT ptr4;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergewl */
    var38.i = ((orc_uint16)var45.i & 0x0000ffff) | ((orc_uint16)var44.i << 16);
    /* 7: storel */
    ptr0[i] = var38;
    /* 9: loadb */
    var40 = ptr5[i];
    ...
    /* 11: mergewl */
    var41.i = ((orc_uint16)var46.i & 0x0000ffff) | ((orc_uint16)var44.i << 16);
    /* 12: storel */
    ptr1[i] = var41;
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_YUY2_I420 (guint8 * d1, guint8 * d2, guint8 * d3, guint8 * d4, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
...
#ifdef DISABLE_ORC
void
cogorc_convert_UYVY_YUY2 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_420_422 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_int8 * ORC_RESTRICT ptr0;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_420_444 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_422_444 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_444_422 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_444_420 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, int n, int m){
  int i;
  int j;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_planar_chroma_422_420 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, int n, int m){
  int i;
  int j;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_convert_YUY2_AYUV (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  ...
  for (j = 0; j < m; j++) {
    ...
    var40.x2[1] = var36.x2[1] & 0xff;
      /* 3: mergebw */
      var41.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var40.x2[0] << 8);
      var41.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var40.x2[1] << 8);
      /* 4: mergewl */
      var42.i = ((orc_uint16)var39.i & 0x0000ffff) | ((orc_uint16)var39.i << 16);
      /* 5: mergewl */
      var38.x2[0] = ((orc_uint16)var41.x2[0] & 0x0000ffff) | ((orc_uint16)var42.x2[0] << 16);
      var38.x2[1] = ((orc_uint16)var41.x2[1] & 0x0000ffff) | ((orc_uint16)var42.x2[1] << 16);
      /* 6: storeq */
      ptr0[i] = var38;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_UYVY_AYUV (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    var40.x2[1] = var36.x2[1] & 0xff;
      /* 3: mergebw */
      var41.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var39.x2[0] << 8);
      var41.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var39.x2[1] << 8);
      /* 4: mergewl */
      var42.i = ((orc_uint16)var40.i & 0x0000ffff) | ((orc_uint16)var40.i << 16);
      /* 5: mergewl */
      var38.x2[0] = ((orc_uint16)var41.x2[0] & 0x0000ffff) | ((orc_uint16)var42.x2[0] << 16);
      var38.x2[1] = ((orc_uint16)var41.x2[1] & 0x0000ffff) | ((orc_uint16)var42.x2[1] << 16);
      /* 6: storeq */
...
#ifdef DISABLE_ORC
void
cogorc_convert_YUY2_Y42B (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_UYVY_Y42B (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_YUY2_Y444 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_UYVY_Y444 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_UYVY_I420 (guint8 * d1, guint8 * d2, guint8 * d3, guint8 * d4, const guint8 * s1, const guint8 * s2, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_I420 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, guint8 * d4, int d4_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_union16 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_YUY2 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    var42.i = var39.i & 0xffff;
      ...
      /* 5: mergebw */
      var38.x2[0] = ((orc_uint8)var44.x2[0] & 0x00ff) | ((orc_uint8)var43.x2[0] << 8);
      var38.x2[1] = ((orc_uint8)var44.x2[1] & 0x00ff) | ((orc_uint8)var43.x2[1] << 8);
      /* 6: storel */
      ptr0[i] = var38;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_UYVY (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    var42.i = var39.i & 0xffff;
      ...
      var44.x2[1] = ((orc_uint16)var40.x2[1] >> 8)&0xff;
      /* 5: mergebw */
      var38.x2[0] = ((orc_uint8)var43.x2[0] & 0x00ff) | ((orc_uint8)var44.x2[0] << 8);
      var38.x2[1] = ((orc_uint8)var43.x2[1] & 0x00ff) | ((orc_uint8)var44.x2[1] << 8);
      /* 6: storel */
      ptr0[i] = var38;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_Y42B (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_Y444 (guint8 * d1, int d1_stride, guint8 * d2, int d2_stride, guint8 * d3, int d3_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_int8 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y42B_YUY2 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var35 = ptr4[i];
      /* 4: mergebw */
      var36.x2[0] = ((orc_uint8)var35.x2[0] & 0x00ff) | ((orc_uint8)var37.x2[0] << 8);
      var36.x2[1] = ((orc_uint8)var35.x2[1] & 0x00ff) | ((orc_uint8)var37.x2[1] << 8);
      /* 5: storel */
      ptr0[i] = var36;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y42B_UYVY (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var35 = ptr4[i];
      /* 4: mergebw */
      var36.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var35.x2[0] << 8);
      var36.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var35.x2[1] << 8);
      /* 5: storel */
      ptr0[i] = var36;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y42B_AYUV (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var39 = ptr4[i];
      /* 5: mergebw */
      var42.x2[0] = ((orc_uint8)var38.x2[0] & 0x00ff) | ((orc_uint8)var39.x2[0] << 8);
      var42.x2[1] = ((orc_uint8)var38.x2[1] & 0x00ff) | ((orc_uint8)var39.x2[1] << 8);
      /* 6: mergewl */
      var43.i = ((orc_uint16)var41.i & 0x0000ffff) | ((orc_uint16)var41.i << 16);
      /* 7: mergewl */
      var40.x2[0] = ((orc_uint16)var42.x2[0] & 0x0000ffff) | ((orc_uint16)var43.x2[0] << 16);
      var40.x2[1] = ((orc_uint16)var42.x2[1] & 0x0000ffff) | ((orc_uint16)var43.x2[1] << 16);
      /* 8: storeq */
      ptr0[i] = var40;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y444_YUY2 (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var37 = ptr6[i];
      /* 2: mergebw */
      var40.x2[0] = ((orc_uint8)var36.x2[0] & 0x00ff) | ((orc_uint8)var37.x2[0] << 8);
      var40.x2[1] = ((orc_uint8)var36.x2[1] & 0x00ff) | ((orc_uint8)var37.x2[1] << 8);
      /* 3: splitlw */
    ...
    var42.i = var40.i & 0xffff;
      ...
      var38 = ptr4[i];
      /* 6: mergebw */
      var39.x2[0] = ((orc_uint8)var38.x2[0] & 0x00ff) | ((orc_uint8)var43.x2[0] << 8);
      var39.x2[1] = ((orc_uint8)var38.x2[1] & 0x00ff) | ((orc_uint8)var43.x2[1] << 8);
      /* 7: storel */
      ptr0[i] = var39;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y444_UYVY (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    var42.i = var40.i & 0xffff;
      ...
      var38 = ptr4[i];
      /* 6: mergebw */
      var39.x2[0] = ((orc_uint8)var43.x2[0] & 0x00ff) | ((orc_uint8)var38.x2[0] << 8);
      var39.x2[1] = ((orc_uint8)var43.x2[1] & 0x00ff) | ((orc_uint8)var38.x2[1] << 8);
      /* 7: storel */
      ptr0[i] = var39;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_Y444_AYUV (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, const guint8 * s2, int s2_stride, const guint8 * s3, int s3_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var40.i = ((orc_uint8)var36 & 0x00ff) | ((orc_uint8)var37 << 8);
      /* 6: mergewl */
      var38.i = ((orc_uint16)var40.i & 0x0000ffff) | ((orc_uint16)var39.i << 16);
      /* 7: storel */
      ptr0[i] = var38;
    }
  }
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_ARGB (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    var63 = var58.i & 0xff;
      ...
      /* 39: mergewl */
      var92.i = ((orc_uint16)var90.i & 0x0000ffff) | ((orc_uint16)var91.i << 16);
      /* 41: addb */
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_BGRA (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_ABGR (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_convert_AYUV_RGBA (guint8 * d1, int d1_stride, const guint8 * s1, int s1_stride, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
...
#ifdef DISABLE_ORC
void
cogorc_convert_I420_BGRA (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 43: mergewl */
    var90.i = ((orc_uint16)var88.i & 0x0000ffff) | ((orc_uint16)var89.i << 16);
    /* 45: addb */
...
#ifdef DISABLE_ORC
void
cogorc_convert_I420_BGRA_avg (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, const guint8 * s5, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 47: mergewl */
    var95.i = ((orc_uint16)var93.i & 0x0000ffff) | ((orc_uint16)var94.i << 16);
    /* 49: addb */
...
#ifdef DISABLE_ORC
void
cogorc_getline_I420 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergewl */
    var38.i = ((orc_uint16)var42.i & 0x0000ffff) | ((orc_uint16)var41.i << 16);
    /* 7: storel */
    ptr0[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_getline_YUV9 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 3: mergewl */
    var43.i = ((orc_uint16)var42.i & 0x0000ffff) | ((orc_uint16)var42.i << 16);
    /* 5: loadw */
    var38 = ptr4[i];
    /* 6: mergebw */
    var44.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var38.x2[0] << 8);
    var44.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var38.x2[1] << 8);
    /* 7: mergewl */
    var39.x2[0] = ((orc_uint16)var44.x2[0] & 0x0000ffff) | ((orc_uint16)var43.x2[0] << 16);
    var39.x2[1] = ((orc_uint16)var44.x2[1] & 0x0000ffff) | ((orc_uint16)var43.x2[1] << 16);
    /* 8: storeq */
    ptr0[i] = var39;
  }
...
cogorc_getline_YVYU (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 4: mergebw */
    var42.x2[0] = ((orc_uint8)var37.x2[0] & 0x00ff) | ((orc_uint8)var40.x2[0] << 8);
    var42.x2[1] = ((orc_uint8)var37.x2[1] & 0x00ff) | ((orc_uint8)var40.x2[1] << 8);
    /* 5: mergewl */
    var43.i = ((orc_uint16)var41.i & 0x0000ffff) | ((orc_uint16)var41.i << 16);
    /* 6: mergewl */
    var38.x2[0] = ((orc_uint16)var42.x2[0] & 0x0000ffff) | ((orc_uint16)var43.x2[0] << 16);
    var38.x2[1] = ((orc_uint16)var42.x2[1] & 0x0000ffff) | ((orc_uint16)var43.x2[1] << 16);
    /* 7: storeq */
    ptr0[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_getline_Y42B (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union64 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_getline_Y444 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
cogorc_getline_Y800 (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    var37.i = ((orc_uint8)var33 & 0x00ff) | ((orc_uint8)var34 << 8);
    /* 4: mergewl */
    var36.i = ((orc_uint16)var37.i & 0x0000ffff) | ((orc_uint16)var35.i << 16);
    /* 5: storel */
    ptr0[i] = var36;
  }
...
cogorc_getline_Y16 (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 5: mergewl */
    var37.i = ((orc_uint16)var39.i & 0x0000ffff) | ((orc_uint16)var36.i << 16);
    /* 6: storel */
    ptr0[i] = var37;
  }
...
cogorc_getline_ABGR (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergewl */
    var41.i = ((orc_uint16)var48.i & 0x0000ffff) | ((orc_uint16)var49.i << 16);
    /* 7: storel */
    ptr0[i] = var41;
  }
...
cogorc_getline_NV12 (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    var35 = ptr5[i];
    /* 2: mergewl */
    var39.i = ((orc_uint16)var34.i & 0x0000ffff) | ((orc_uint16)var35.i << 16);
    /* 4: loadw */
    var37 = ptr4[i];
    /* 5: mergebw */
    var40.x2[0] = ((orc_uint8)var36.x2[0] & 0x00ff) | ((orc_uint8)var37.x2[0] << 8);
    var40.x2[1] = ((orc_uint8)var36.x2[1] & 0x00ff) | ((orc_uint8)var37.x2[1] << 8);
    /* 6: mergewl */
    var38.x2[0] = ((orc_uint16)var40.x2[0] & 0x0000ffff) | ((orc_uint16)var39.x2[0] << 16);
    var38.x2[1] = ((orc_uint16)var40.x2[1] & 0x0000ffff) | ((orc_uint16)var39.x2[1] << 16);
    /* 7: storeq */
    ptr0[i] = var38;
  }
...
cogorc_getline_NV21 (guint8 * d1, const guint8 * s1, const guint8 * s2, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 2: mergewl */
    var40.i = ((orc_uint16)var39.i & 0x0000ffff) | ((orc_uint16)var39.i << 16);
    /* 4: loadw */
    var37 = ptr4[i];
    /* 5: mergebw */
    var41.x2[0] = ((orc_uint8)var36.x2[0] & 0x00ff) | ((orc_uint8)var37.x2[0] << 8);
    var41.x2[1] = ((orc_uint8)var36.x2[1] & 0x00ff) | ((orc_uint8)var37.x2[1] << 8);
    /* 6: mergewl */
    var38.x2[0] = ((orc_uint16)var41.x2[0] & 0x0000ffff) | ((orc_uint16)var40.x2[0] << 16);
    var38.x2[1] = ((orc_uint16)var41.x2[1] & 0x0000ffff) | ((orc_uint16)var40.x2[1] << 16);
    /* 7: storeq */
    ptr0[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_getline_A420 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
#ifdef DISABLE_ORC
void
cogorc_putline_I420 (guint8 * d1, guint8 * d2, guint8 * d3, const guint8 * s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
cogorc_putline_YVYU (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergebw */
    var38.x2[0] = ((orc_uint8)var44.x2[0] & 0x00ff) | ((orc_uint8)var45.x2[0] << 8);
    var38.x2[1] = ((orc_uint8)var44.x2[1] & 0x00ff) | ((orc_uint8)var45.x2[1] << 8);
    /* 7: storel */
    ptr0[i] = var38;
  }
...
#ifdef DISABLE_ORC
void
cogorc_putline_Y42B (guint8 * d1, guint8 * d2, guint8 * d3, const guint8 * s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
#ifdef DISABLE_ORC
void
cogorc_putline_Y444 (guint8 * d1, guint8 * d2, guint8 * d3, const guint8 * s1, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
...
cogorc_putline_RGBA (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergewl */
    var41.i = ((orc_uint16)var49.i & 0x0000ffff) | ((orc_uint16)var48.i << 16);
    /* 7: storel */
    ptr0[i] = var41;
  }
...
#ifdef DISABLE_ORC
void
cogorc_putline_A420 (guint8 * d1, guint8 * d2, guint8 * d3, guint8 * d4, const guint8 * s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
  orc_int8 * ORC_RESTRICT ptr1;
  orc_int8 * ORC_RESTRICT ptr2;
